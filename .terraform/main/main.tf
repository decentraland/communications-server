...
resource "aws_ecs_task_definition" "this" {
  ...
  cpu = 256
  memory = 2048
  container_definitions = "${file("../config/${var.region}/${var.env}/container_definition/communications-server.json")}"
...
resource "aws_cloudwatch_log_group" "this" {
  name              = "/fargate/service/communications-server/communications-server-${var.env}"
